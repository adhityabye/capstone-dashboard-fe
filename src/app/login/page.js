  ...
  return (
    <div className="flex items-center justify-center h-full bg-gradient-to-br from-blue-100 to-purple-100">
      <div className="w-full max-w-md px-8 py-10 bg-white rounded-2xl shadow-xl transition-all duration-300 ease-in-out hover:shadow-2xl max-h-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border text-gray-800 font-semibold border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
              value={username}
        ...
        {error && (
          <p
            className="mt-4 text-sm text-red-600 bg-red-100 p-3 rounded-lg transition-all duration-300 ease-in-out"
            role="alert"
          >
            {error}
          </p>
